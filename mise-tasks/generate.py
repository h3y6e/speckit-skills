...
COMMON_PATCHES: Patches = [
    ...
    (".specify/extensions.yml", "specs/extensions.yml"),
...
SKILL_PATCHES: dict[str, dict[str, Patches]] = {
    "speckit-specify": {
        "SKILL.md": [
            ...
            ('.specify/scripts/bash/create-new-feature.sh "$ARGUMENTS" --json --short-name "user-auth" "Add user authentication"', '.specify/scripts/bash/create-new-feature.sh "<feature-description>" --json --short-name "user-auth" "Add user authentication"'),
            ('.specify/scripts/bash/create-new-feature.sh "$ARGUMENTS" -Json -ShortName "user-auth" "Add user authentication"', '.specify/scripts/bash/create-new-feature.sh "<feature-description>" -Json -ShortName "user-auth" "Add user authentication"'),
        ],
        "references/spec-template.md": [
